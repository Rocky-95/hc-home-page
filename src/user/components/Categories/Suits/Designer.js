...
const categories =[
  { 
    ...
    description: "A bold midnight designer suit crafted for premium evening fashion statements.", 
    link: "/wedding" 
  },
  ...
  { 
    ...
    description: "Luxurious velvet blazer designed for high-end style and elegant presence." 
  },
  ...
  { 
    ...
    description: "An iconic designer suit built for standout modern fashion." 
  },
  ...
  { 
    ...
    image: TheRoyalWeddingEdit, 
    description: "Sharp contemporary tailoring with a sleek designer finish." 
  },
  ...
  { 
    ...
    video: TheChurchAffair, 
    description: "Premium royal suit crafted for luxury and elegance." 
  },
  ...
  { 
    ...
    description: "Trendy designer outfit perfect for stylish parties and night events." 
  },
  ...
  { 
    ...
    image: TheRoyalWeddingEdit, 
    description: "Rich textured suit adding depth and uniqueness to your look." 
  },
  ...
  { 
    ...
    image: TheDestinationDream, 
    description: "A fusion of modern tailoring with traditional designer aesthetics." 
  },
  ...
  { 
    ...
    image: TheDestinationDream, 
    description: "A bold black designer suit for confident and iconic fashion statements." 
  },
];
    ...
    <>
      ...
      >
        <div className="d-flex justify-content-between align-items-center px-3">
          ...
          {/* Center: Title */}
          <h1 className="h5 mb-0 text-dark text-center flex-grow-1">Designer</h1>
