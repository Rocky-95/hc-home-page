...
const categories = [
  { 
    ...
    description: "A luxurious royal outfit designed to make your baby shine at wedding ceremonies.", 
    // link: "/baby-suits" 
  },
  ...
  { 
    ...
    description: "An elegant navy suit perfect for wedding functions and formal gatherings." 
  },
  ...
  { 
    ...
    description: "A stylish black outfit crafted for a bold and classy wedding look." 
  },
  ...
  { 
    ...
    image: TheRoyalWeddingEdit, 
    description: "A soft beige wedding outfit offering elegance and comfort for special moments." 
  },
  ...
  { 
    ...
    video: TheChurchAffair, 
    description: "A trendy striped outfit adding a playful touch to wedding celebrations." 
  },
  ...
  { 
    ...
    description: "A bright blue outfit designed for cheerful and stylish wedding appearances." 
  },
  ...
  { 
    ...
    image: TheRoyalWeddingEdit, 
    description: "A rich brown outfit perfect for a warm and elegant wedding vibe." 
  },
  ...
  { 
    ...
    video: TheChurchAffair, 
    description: "A stylish check-pattern outfit that enhances your baby’s wedding look." 
  },
  ...
  { 
    ...
    image: TheDestinationDream, 
    description: "A modern grey outfit combining elegance and charm for wedding occasions." 
  },
];
    ...
    <>
      ...
      >
        <div className="d-flex justify-content-between align-items-center px-3">
          ...
          {/* Center: Title */}
          <h1 className="h5 mb-0 text-dark text-center flex-grow-1">Wedding Baby Suits</h1>
