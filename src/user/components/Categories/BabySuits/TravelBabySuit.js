...
const TravelBabySuit = () => (
  <CategoryPageTemplate
    ...
    heroHeadline="Mini Traveller Series"
    heroSubline="Comfort Meets Style On the Go."
    runningText="Soft. Comfy. Impeccably dressed."
    leftImg={leftImg}
    centerVideo={centerVideo}
    rightImg={rightImg}
    sliderImages={[sliderImg1, sliderImg2, sliderImg3]}
    sliderDescription="<h3>Mini Traveller Series</h3><p>Comfort Meets Style On the Go.</p>"
    labelVideo={LabelVideo}
    labelImage={LabelImage}
    fadeText="The Travel Baby Suit Collection"
