...
const categories = [
  { 
    ...
    description: "A soft and breathable outfit designed to keep your baby comfortable during long journeys.", 
    // link: "/baby-suits" 
  },
  ...
  { 
    ...
    description: "A relaxed navy outfit perfect for travel days with a mix of style and ease." 
  },
  ...
  { 
    ...
    description: "A sleek black travel outfit designed for a clean and fuss-free look on the go." 
  },
  ...
  { 
    ...
    image: TheRoyalWeddingEdit, 
    description: "A light beige outfit offering comfort and flexibility for travel and outdoor trips." 
  },
  ...
  { 
    ...
    video: TheChurchAffair, 
    description: "A playful striped outfit that keeps your baby stylish and comfortable while traveling." 
  },
  ...
  { 
    ...
    description: "A fresh blue outfit designed for active and cheerful travel moments." 
  },
  ...
  { 
    ...
    image: TheRoyalWeddingEdit, 
    description: "A cozy brown outfit perfect for relaxed travel and long journeys." 
  },
  ...
  { 
    ...
    video: TheChurchAffair, 
    description: "A stylish check-pattern outfit that adds charm to your baby’s travel wardrobe." 
  },
  ...
  { 
    ...
    image: TheDestinationDream, 
    description: "A modern grey outfit designed for comfort, mobility, and smart travel style." 
  },
];
    ...
    <>
      ...
      >
        <div className="d-flex justify-content-between align-items-center px-3">
          ...
          {/* Center: Title */}
          <h1 className="h5 mb-0 text-dark text-center flex-grow-1">Travel Baby Suits</h1>
