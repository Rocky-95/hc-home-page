...
const categories = [
  { 
    ...
    description: "Smart and adorable executive-style suit designed for little gentlemen.", 
    link: "/baby-suits/business" 
  },
  ...
  { 
    ...
    description: "Elegant navy blazer set perfect for formal occasions and celebrations." 
  },
  ...
  { 
    ...
    description: "Classic black formal outfit tailored for a charming and stylish look." 
  },
  ...
  { 
    ...
    image: TheRoyalWeddingEdit, 
    description: "Soft beige outfit offering comfort and elegance for special moments." 
  },
  ...
  { 
    ...
    video: TheChurchAffair, 
    description: "Trendy pinstripe suit bringing a stylish and playful formal vibe." 
  },
  ...
  { 
    ...
    description: "Fresh and vibrant light blue suit perfect for cheerful occasions." 
  },
  ...
  { 
    ...
    image: TheRoyalWeddingEdit, 
    description: "Comfortable brown suit designed for a relaxed yet smart appearance." 
  },
  ...
  { 
    ...
    video: TheChurchAffair, 
    description: "Stylish checkered outfit adding a fun twist to classic formal wear." 
  },
  ...
  { 
    ...
    image: TheDestinationDream, 
    description: "Modern slim-fit grey suit crafted for a sharp and adorable look." 
  },
];
    ...
    <>
      ...
      >
        <div className="d-flex justify-content-between align-items-center px-3">
          ...
          {/* Center: Title */}
          <h1 className="h5 mb-0 text-dark text-center flex-grow-1">Business Baby Suits</h1>
