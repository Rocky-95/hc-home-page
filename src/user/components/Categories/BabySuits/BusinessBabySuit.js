...
const BusinessBabySuit = () => (
  <CategoryPageTemplate
    ...
    heroHeadline="Mini Executive Series"
    heroSubline="Sharp From the Start."
    runningText="Tiny suits, big impressions."
    leftImg={leftImg}
    centerVideo={centerVideo}
    rightImg={rightImg}
    sliderImages={[sliderImg1, sliderImg2, sliderImg3]}
    sliderDescription="<h3>Mini Executive Series</h3><p>Sharp From the Start.</p>"
    labelVideo={LabelVideo}
    labelImage={LabelImage}
    fadeText="The Business Baby Suit Collection"
