...
const DesignerBabySuit = () => (
  <CategoryPageTemplate
    ...
    heroHeadline="Little Couture Series"
    heroSubline="Style Has No Age Limit."
    runningText="Designer looks for the boldest little ones."
    leftImg={leftImg}
    centerVideo={centerVideo}
    rightImg={rightImg}
    sliderImages={[sliderImg1, sliderImg2, sliderImg3]}
    sliderDescription="<h3>Little Couture Series</h3><p>Style Has No Age Limit.</p>"
