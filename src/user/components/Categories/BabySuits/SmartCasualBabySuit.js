...
const SmartCasualBabySuit = () => (
  <CategoryPageTemplate
    ...
    heroHeadline="Smart Little Series"
    heroSubline="Effortlessly Cute, Always Sharp."
    runningText="Miniature smart-casual perfection."
    leftImg={leftImg}
    centerVideo={centerVideo}
    rightImg={rightImg}
    sliderImages={[sliderImg1, sliderImg2, sliderImg3]}
    sliderDescription="<h3>Smart Little Series</h3><p>Effortlessly Cute, Always Sharp.</p>"
    labelVideo={LabelVideo}
    labelImage={LabelImage}
    fadeText="The Smart Casual Baby Suit Collection"
