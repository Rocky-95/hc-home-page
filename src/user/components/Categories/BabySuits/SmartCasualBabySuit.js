...
const categories = [
  { 
    ...
    description: "A soft beige smart casual outfit designed for comfort and everyday elegance.", 
    // link: "/baby-suits" 
  },
  ...
  { 
    ...
    description: "A relaxed navy outfit combining smart looks with playful comfort." 
  },
  ...
  { 
    ...
    description: "A sleek black casual outfit perfect for a neat and modern baby look." 
  },
  ...
  { 
    ...
    image: TheRoyalWeddingEdit, 
    description: "Comfortable beige outfit crafted for everyday wear with a stylish touch." 
  },
  ...
  { 
    ...
    video: TheChurchAffair, 
    description: "A playful striped outfit designed for a trendy and cheerful look." 
  },
  ...
  { 
    ...
    description: "Bright blue casual wear offering a fresh and charming baby style." 
  },
  ...
  { 
    ...
    image: TheRoyalWeddingEdit, 
    description: "A cozy brown outfit designed for relaxed and comfortable daily wear." 
  },
  ...
  { 
    ...
    video: TheChurchAffair, 
    description: "A stylish check-pattern outfit adding fun and charm to casual dressing." 
  },
  ...
  { 
    ...
    image: TheDestinationDream, 
    description: "A modern grey casual outfit combining comfort with a smart appearance." 
  },
];
    ...
    <>
      ...
      >
        <div className="d-flex justify-content-between align-items-center px-3">
          ...
          {/* Center: Title */}
          <h1 className="h5 mb-0 text-dark text-center flex-grow-1">Smart Casual Baby Suits</h1>
