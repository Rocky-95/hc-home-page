...
const SmartCasualTrouser = () => (
  <CategoryPageTemplate
    ...
    heroHeadline="Smart Casual Trouser"
    heroSubline="Relaxed Fit, Refined Finish."
    runningText="Easy elegance for every occasion."
    leftImg={leftImg}
    centerVideo={centerVideo}
    rightImg={rightImg}
    sliderImages={[sliderImg1, sliderImg2, sliderImg3]}
    sliderDescription="<h3>Smart Casual Trouser</h3><p>Relaxed Fit, Refined Finish.</p>"
    labelVideo={LabelVideo}
    labelImage={LabelImage}
    fadeText="The Smart Casual Trouser Collection"
