...
const categories = [
  { 
    ...
    description: "A versatile chino trouser designed for a relaxed yet polished smart casual look.", 
    // link: "/collection/smart-casual-trousers" 
  },
  ...
  { 
    ...
    description: "A refined navy trouser blending comfort with a clean and modern casual style." 
  },
  ...
  { 
    ...
    description: "A sleek black trouser perfect for a minimal and stylish smart casual appearance." 
  },
  ...
  { 
    ...
    image: TheRoyalWeddingEdit, 
    description: "A soft beige trouser offering comfort and ease for everyday smart casual wear." 
  },
  ...
  { 
    ...
    video: TheChurchAffair, 
    description: "A stylish striped trouser that adds a trendy touch to your casual outfits." 
  },
  ...
  { 
    ...
    description: "A fresh blue trouser crafted for a comfortable and stylish daily look." 
  },
  ...
  { 
    ...
    image: TheRoyalWeddingEdit, 
    description: "A cozy brown trouser designed for relaxed and effortless smart casual styling." 
  },
  ...
  { 
    ...
    video: TheChurchAffair, 
    description: "A check-pattern trouser perfect for a modern and fashionable casual vibe." 
  },
  ...
  { 
    ...
    image: TheDestinationDream, 
    description: "A modern grey trouser combining comfort with a clean and smart casual finish." 
  },
];
    ...
    <>
      ...
      >
        <div className="d-flex justify-content-between align-items-center px-3">
          ...
          {/* Center: Title */}
          <h1 className="h5 mb-0 text-dark text-center flex-grow-1">Smart Casual Trousers</h1>
