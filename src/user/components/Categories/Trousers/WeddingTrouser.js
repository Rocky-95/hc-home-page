...
const WeddingTrouser = () => (
  <CategoryPageTemplate
    ...
    heroHeadline="The Wedding Trouser"
    heroSubline="Complete the Look with Precision."
    runningText="Perfectly tailored for your big day."
    leftImg={leftImg}
    centerVideo={centerVideo}
    rightImg={rightImg}
    sliderImages={[sliderImg1, sliderImg2, sliderImg3]}
    sliderDescription="<h3>The Wedding Trouser</h3><p>Complete the Look with Precision.</p>"
    labelVideo={LabelVideo}
    labelImage={LabelImage}
    fadeText="The Wedding Trouser Collection"
