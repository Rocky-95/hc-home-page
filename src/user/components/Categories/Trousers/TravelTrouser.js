...
const TravelTrouser = () => (
  <CategoryPageTemplate
    ...
    heroHeadline="The Travel Trouser"
    heroSubline="Move Freely, Look Immaculate."
    runningText="Lightweight. Wrinkle-free. Always ready."
    leftImg={leftImg}
    centerVideo={centerVideo}
    rightImg={rightImg}
    sliderImages={[sliderImg1, sliderImg2, sliderImg3]}
    sliderDescription="<h3>The Travel Trouser</h3><p>Move Freely, Look Immaculate.</p>"
    labelVideo={LabelVideo}
    labelImage={LabelImage}
    fadeText="The Travel Trouser Collection"
