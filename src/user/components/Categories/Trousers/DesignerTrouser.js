...
const DesignerTrouser = () => (
  <CategoryPageTemplate
    ...
    heroHeadline="The Artisan Trouser"
    heroSubline="Detail That Sets You Apart."
    runningText="Couture trousers for the discerning eye."
    leftImg={leftImg}
    centerVideo={centerVideo}
    rightImg={rightImg}
    sliderImages={[sliderImg1, sliderImg2, sliderImg3]}
    sliderDescription="<h3>The Artisan Trouser</h3><p>Detail That Sets You Apart.</p>"
    labelVideo={LabelVideo}
    labelImage={LabelImage}
    fadeText="The Designer Trouser Collection"
