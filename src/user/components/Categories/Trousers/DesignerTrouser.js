...
const categories = [
  { 
    ...
    description: "A premium designer trouser featuring intricate detailing for a bold and luxurious statement.", 
    // link: "/collection/designer-trousers" 
  },
  ...
  { 
    ...
    description: "A refined navy designer trouser crafted with premium fabric and modern tailoring." 
  },
  ...
  { 
    ...
    description: "A sleek black designer trouser built for a bold and signature fashion statement." 
  },
  ...
  { 
    ...
    image: TheRoyalWeddingEdit, 
    description: "A soft beige designer trouser offering elegance with a minimal luxury touch." 
  },
  ...
  { 
    ...
    video: TheChurchAffair, 
    description: "A stylish striped designer trouser that blends trend with high-end fashion." 
  },
  ...
  { 
    ...
    description: "A vibrant blue designer trouser crafted for a fresh and modern designer look." 
  },
  ...
  { 
    ...
    image: TheRoyalWeddingEdit, 
    description: "A rich brown designer trouser designed for a warm and premium appearance." 
  },
  ...
  { 
    ...
    video: TheChurchAffair, 
    description: "A check-pattern designer trouser that adds a fashionable and trendy edge." 
  },
  ...
  { 
    ...
    image: TheDestinationDream, 
    description: "A sleek grey designer trouser with a slim fit for a sharp and modern silhouette." 
  },
];
    ...
    <>
      ...
      >
        <div className="d-flex justify-content-between align-items-center px-3">
          ...
          {/* Center: Title */}
          <h1 className="h5 mb-0 text-dark text-center flex-grow-1">Designer Trousers</h1>
