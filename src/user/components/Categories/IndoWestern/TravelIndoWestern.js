...
const categories = [
  { 
    ...
    description: "A relaxed Indo-Western outfit designed for maximum comfort during travel and long journeys.", 
    // link: "/indowestern/travel" 
  },
  ...
  { 
    ...
    description: "A smart navy Indo-Western outfit combining style and ease for travel days." 
  },
  ...
  { 
    ...
    description: "A sleek black Indo-Western ensemble crafted for a clean and minimal travel look." 
  },
  ...
  { 
    ...
    image: TheRoyalWeddingEdit, 
    description: "A lightweight beige Indo-Western outfit offering comfort and flexibility on the go." 
  },
  ...
  { 
    ...
    video: TheChurchAffair, 
    description: "A trendy striped Indo-Western outfit adding a playful vibe to your travel wardrobe." 
  },
  ...
  { 
    ...
    description: "A fresh blue Indo-Western outfit designed for active and stylish travel moments." 
  },
  ...
  { 
    ...
    image: TheRoyalWeddingEdit, 
    description: "A cozy brown Indo-Western outfit perfect for relaxed journeys and everyday travel wear." 
  },
  ...
  { 
    ...
    video: TheChurchAffair, 
    description: "A stylish check-pattern Indo-Western outfit ideal for a modern and comfortable travel look." 
  },

  { 
    id: "indo-grey-travel-fit", 
    name: "Indo Grey Travel Fit", 
    image: TheDestinationDream, 
    description: "A modern grey Indo-Western outfit offering a perfect blend of comfort and travel-ready style." 
  },
];
    ...
    <>
      ...
      >
        <div className="d-flex justify-content-between align-items-center px-3">
          ...
          {/* Center: Title */}
          <h1 className="h5 mb-0 text-dark text-center flex-grow-1">Travel Indo-Western </h1>
