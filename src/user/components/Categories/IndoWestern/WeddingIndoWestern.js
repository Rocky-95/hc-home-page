...
const WeddingPage = () => {
  ...
  const categories = [
    { 
      ...
      description: "A luxurious Indo-Western outfit crafted to give a royal and grand wedding appearance.", 
      // link: "/indowestern/wedding" 
    },
    ...
    { 
      ...
      description: "An elegant navy Indo-Western outfit perfect for wedding ceremonies and formal events." 
    },
    ...
    { 
      ...
      description: "A bold black Indo-Western ensemble designed for a classy and striking wedding look." 
    },
    ...
    { 
      ...
      image: TheRoyalWeddingEdit, 
      description: "A soft beige Indo-Western outfit offering elegance and sophistication for wedding occasions." 
    },
    ...
    { 
      ...
      video: TheChurchAffair, 
      description: "A stylish striped Indo-Western outfit adding a modern twist to wedding fashion." 
    },
    ...
    { 
      ...
      description: "A vibrant blue Indo-Western outfit perfect for festive wedding celebrations." 
    },
    ...
    { 
      ...
      image: TheRoyalWeddingEdit, 
      description: "A rich brown Indo-Western outfit crafted for a warm and premium wedding style." 
    },
    ...
    { 
      ...
      video: TheChurchAffair, 
      description: "A stylish check-pattern Indo-Western outfit ideal for a unique wedding look." 
    },
    ...
    { 
      ...
      image: TheDestinationDream, 
      description: "A modern grey Indo-Western outfit combining elegance and charm for wedding occasions." 
    },
  ];
    ...
    <>
      ...
      >
        <div className="d-flex justify-content-between align-items-center px-3">
          ...
          {/* Center: Title */}
          <h1 className="h5 mb-0 text-dark text-center flex-grow-1">Wedding Indo-Western </h1>
