...
const WeddingPage = () => (
  <CategoryPageTemplate
    ...
    heroSubline="For the Men Who Wear Royalty."
    runningText="Handcrafted elegance for unforgettable moments."
    leftImg={leftImg}
    centerVideo={centerVideo}
    rightImg={rightImg}
    sliderImages={[sliderImg1, sliderImg2, sliderImg3]}
    sliderDescription="<h3>Velvet Royal Series</h3><p>For the Men Who Wear Royalty.</p>"
    labelVideo={LabelVideo}
    labelImage={LabelImage}
    fadeText="The Wedding Indo-Western Collection"
    categories={categories}
    productBasePath="/product"
    categoryPath="/indo-western"
