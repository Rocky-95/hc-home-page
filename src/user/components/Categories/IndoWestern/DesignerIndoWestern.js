...
const categories = [
  { 
    ...
    description: "A luxurious designer Indo-Western outfit crafted for a royal and statement look.", 
    // link: "/indowestern/designer" 
  },
  ...
  { 
    ...
    description: "A premium navy designer Indo-Western outfit blending elegance with modern flair." 
  },
  ...
  { 
    ...
    description: "A bold black designer Indo-Western ensemble made for a standout appearance." 
  },
  ...
  { 
    ...
    image: TheRoyalWeddingEdit, 
    description: "A soft beige designer outfit offering refined elegance with a modern touch." 
  },
  ...
  { 
    ...
    video: TheChurchAffair, 
    description: "A stylish striped designer Indo-Western outfit adding a trendy contemporary vibe." 
  },
  ...
  { 
    ...
    description: "A vibrant blue designer outfit crafted for a fresh and fashionable appearance." 
  },
  ...
  { 
    ...
    image: TheRoyalWeddingEdit, 
    description: "A rich brown designer Indo-Western outfit designed for a warm and premium look." 
  },
  ...
  { 
    ...
    video: TheChurchAffair, 
    description: "A modern check-pattern designer outfit perfect for a stylish and unique look." 
  },
  ...
  { 
    ...
    image: TheDestinationDream, 
    description: "A signature grey designer Indo-Western outfit combining elegance with modern tailoring." 
  },
];
    ...
    <>
      ...
      >
        <div className="d-flex justify-content-between align-items-center px-3">
          ...
          {/* Center: Title */}
          <h1 className="h5 mb-0 text-dark text-center flex-grow-1">Designer Indo-Western </h1>
