...
const categories = [
  { 
    ...
    description: "A refined Indo-Western outfit blending traditional elegance with modern business style.", 
    // link: "/indowestern/business" 
  },
  ...
  { 
    ...
    description: "A sharp navy Indo-Western outfit perfect for professional and corporate settings." 
  },
  ...
  { 
    ...
    description: "A sleek black Indo-Western ensemble crafted for a bold and confident office look." 
  },
  ...
  { 
    ...
    image: TheRoyalWeddingEdit, 
    description: "A soft beige Indo-Western outfit offering a clean and polished business appearance." 
  },
  ...
  { 
    ...
    video: TheChurchAffair, 
    description: "A stylish striped Indo-Western outfit bringing a modern twist to business wear." 
  },
  ...
  { 
    ...
    description: "A fresh blue Indo-Western outfit designed for confident and professional settings." 
  },
  ...
  { 
    ...
    image: TheRoyalWeddingEdit, 
    description: "A rich brown Indo-Western outfit crafted for a warm and sophisticated business look." 
  },
  ...
  { 
    ...
    video: TheChurchAffair, 
    description: "A stylish check-pattern Indo-Western outfit ideal for modern corporate fashion." 
  },
  ...
  { 
    ...
    image: TheDestinationDream, 
    description: "A modern grey Indo-Western outfit combining elegance with a sharp executive style." 
  },
];
    ...
    <>
      ...
      >
        <div className="d-flex justify-content-between align-items-center px-3">
          ...
          {/* Center: Title */}
          <h1 className="h5 mb-0 text-dark text-center flex-grow-1">Business Indo-Western </h1>
