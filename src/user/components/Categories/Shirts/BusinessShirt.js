...
const BusinessShirt = () => (
  <CategoryPageTemplate
    ...
    heroHeadline="The Executive Shirt"
    heroSubline="Authority Starts With a Crisp Collar."
    runningText="Precision stitched for boardroom confidence."
    leftImg={leftImg}
    centerVideo={centerVideo}
    rightImg={rightImg}
    sliderImages={[sliderImg1, sliderImg2, sliderImg3]}
    sliderDescription="<h3>The Executive Shirt</h3><p>Authority Starts With a Crisp Collar.</p>"
    labelVideo={LabelVideo}
    labelImage={LabelImage}
    fadeText="The Business Shirt Collection"
