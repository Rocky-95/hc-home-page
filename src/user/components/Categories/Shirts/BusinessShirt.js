...
const categories = [
  { 
    ...
    description: "A timeless white shirt designed for a clean, sharp, and professional business look.", 
    // link: "/shirts/business" 
  },
  ...
  { 
    ...
    description: "A deep navy shirt offering a refined and confident appearance for formal settings." 
  },
  ...
  { 
    ...
    description: "A sleek black shirt crafted for bold and modern professional styling." 
  },
  ...
  { 
    ...
    image: TheRoyalWeddingEdit, 
    description: "A soft beige shirt perfect for a subtle and elegant office look." 
  },
  ...
  { 
    ...
    video: TheChurchAffair, 
    description: "A stylish striped shirt that adds a modern touch to business attire." 
  },
  ...
  { 
    ...
    description: "A fresh light blue shirt designed for a smart and approachable professional look." 
  },
  ...
  { 
    ...
    image: TheRoyalWeddingEdit, 
    description: "A rich brown shirt offering a warm and sophisticated office appearance." 
  },
  ...
  { 
    ...
    video: TheChurchAffair, 
    description: "A check-pattern shirt combining comfort with a stylish corporate vibe." 
  },
  ...
  { 
    ...
    image: TheDestinationDream, 
    description: "A modern grey slim-fit shirt tailored for a sharp and professional finish." 
  },
];
    ...
    <>
      ...
      >
        <div className="d-flex justify-content-between align-items-center px-3">
          ...
          {/* Center: Title */}
          <h1 className="h5 mb-0 text-dark text-center flex-grow-1">Business Shirt</h1>
