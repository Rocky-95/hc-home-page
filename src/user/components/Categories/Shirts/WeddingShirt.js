...
const WeddingShirt = () => (
  <CategoryPageTemplate
    ...
    heroHeadline="The Wedding Shirt Edit"
    heroSubline="The Perfect Shirt for Your Big Day."
    runningText="Handcrafted shirts for unforgettable moments."
    leftImg={leftImg}
    centerVideo={centerVideo}
    rightImg={rightImg}
    sliderImages={[sliderImg1, sliderImg2, sliderImg3]}
    sliderDescription="<h3>The Wedding Shirt Edit</h3><p>The Perfect Shirt for Your Big Day.</p>"
    labelVideo={LabelVideo}
    labelImage={LabelImage}
    fadeText="The Wedding Shirt Collection"
