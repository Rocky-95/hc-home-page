...
const SmartCasualShirt = () => (
  <CategoryPageTemplate
    ...
    heroHeadline="Smart Casual Shirt"
    heroSubline="Effortlessly Sharp, Always."
    runningText="Modern ease, tailored precision."
    leftImg={leftImg}
    centerVideo={centerVideo}
    rightImg={rightImg}
    sliderImages={[sliderImg1, sliderImg2, sliderImg3]}
    sliderDescription="<h3>Smart Casual Shirt</h3><p>Effortlessly Sharp, Always.</p>"
    labelVideo={LabelVideo}
    labelImage={LabelImage}
    fadeText="The Smart Casual Shirt Collection"
