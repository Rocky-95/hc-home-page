...
const categories = [
  { 
    ...
    description: "A breathable linen shirt designed for a relaxed yet refined smart casual look.", 
    // link: "/collection/smart-casual-shirts" 
  },
  ...
  { 
    ...
    description: "A versatile navy shirt blending comfort with a polished everyday style." 
  },
  ...
  { 
    ...
    description: "A sleek black shirt perfect for a minimal and modern smart casual appearance." 
  },
  ...
  { 
    ...
    image: TheRoyalWeddingEdit, 
    description: "A soft beige shirt offering comfort and elegance for everyday casual wear." 
  },
  ...
  { 
    ...
    video: TheChurchAffair, 
    description: "A stylish striped shirt that adds a trendy touch to smart casual outfits." 
  },
  ...
  { 
    ...
    description: "A fresh blue shirt crafted for a comfortable and stylish daily look." 
  },
  ...
  { 
    ...
    image: TheRoyalWeddingEdit, 
    description: "A cozy brown shirt designed for relaxed and effortless smart casual styling." 
  },
  ...
  { 
    ...
    video: TheChurchAffair, 
    description: "A check-pattern shirt perfect for a modern and fashionable casual vibe." 
  },
  ...
  { 
    ...
    image: TheDestinationDream, 
    description: "A modern grey shirt combining comfort with a clean and smart casual finish." 
  },
];
    ...
    <>
      ...
      >
        <div className="d-flex justify-content-between align-items-center px-3">
          ...
          {/* Center: Title */}
          <h1 className="h5 mb-0 text-dark text-center flex-grow-1">Smart Casual Shirt</h1>
