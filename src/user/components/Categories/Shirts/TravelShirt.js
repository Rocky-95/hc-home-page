...
const categories = [
  { 
    ...
    description: "A breathable lightweight shirt designed for maximum comfort during travel and long journeys.", 
    // link: "/collection/travel-shirts" 
  },
  ...
  { 
    ...
    description: "A relaxed navy shirt combining smart style with all-day travel comfort." 
  },
  ...
  { 
    ...
    description: "A sleek black shirt crafted for a minimal and versatile travel wardrobe." 
  },
  ...
  { 
    ...
    image: TheRoyalWeddingEdit, 
    description: "A soft beige shirt offering flexibility and ease for outdoor travel and trips." 
  },
  ...
  { 
    ...
    video: TheChurchAffair, 
    description: "A stylish striped shirt that adds a playful vibe to your travel outfits." 
  },
  ...
  { 
    ...
    description: "A fresh blue shirt designed to keep you cool and stylish during travel." 
  },
  ...
  { 
    ...
    image: TheRoyalWeddingEdit, 
    description: "A cozy brown shirt perfect for relaxed journeys and everyday travel wear." 
  },
  ...
  { 
    ...
    video: TheChurchAffair, 
    description: "A check-pattern shirt built for stylish adventures and travel outings." 
  },
  ...
  { 
    ...
    image: TheDestinationDream, 
    description: "A modern grey shirt combining comfort with a clean and travel-ready look." 
  },
];
    ...
    <>
      ...
      >
        <div className="d-flex justify-content-between align-items-center px-3">
          ...
          {/* Center: Title */}
          <h1 className="h5 mb-0 text-dark text-center flex-grow-1">Travel Shirt</h1>
