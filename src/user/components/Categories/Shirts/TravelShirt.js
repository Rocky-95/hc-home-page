...
const TravelShirt = () => (
  <CategoryPageTemplate
    ...
    heroHeadline="The Travel Shirt"
    heroSubline="Comfort and Style, Wherever You Go."
    runningText="Wrinkle-resistant. Breathable. Impeccable."
    leftImg={leftImg}
    centerVideo={centerVideo}
    rightImg={rightImg}
    sliderImages={[sliderImg1, sliderImg2, sliderImg3]}
    sliderDescription="<h3>The Travel Shirt</h3><p>Comfort and Style, Wherever You Go.</p>"
    labelVideo={LabelVideo}
    labelImage={LabelImage}
    fadeText="The Travel Shirt Collection"
