...
const DesignerShirt = () => (
  <CategoryPageTemplate
    ...
    heroHeadline="The Artisan Shirt"
    heroSubline="Wear Art, Not Just Fabric."
    runningText="Couture shirts for the bold and creative."
    leftImg={leftImg}
    centerVideo={centerVideo}
    rightImg={rightImg}
    sliderImages={[sliderImg1, sliderImg2, sliderImg3]}
    sliderDescription="<h3>The Artisan Shirt</h3><p>Wear Art, Not Just Fabric.</p>"
    labelVideo={LabelVideo}
    labelImage={LabelImage}
    fadeText="The Designer Shirt Collection"
